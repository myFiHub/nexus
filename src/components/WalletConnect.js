...
const WalletConnect = () => {
  const { walletState, isConnected, isLoading, error, connectWallet, disconnectWallet } = useApp();
  ...
  const handleClickOutside = (e) => {
    if (e.target.closest('.wallet-dropdown') || e.target.closest('.wallet-options')) return;
      ...
      <div className="wallet-connect-container">
        ...
        >
          <span className="wallet-icon">
            {getWalletIcon(walletState.type)}
          </span>
